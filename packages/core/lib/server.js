...
var createRouter = function (router) {
    ...
    return {
        listen: function () {
            ...
            handlerFactory(Verbs.use)(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["*"], ["*"])))([])(function () {
